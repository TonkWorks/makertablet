...
import com.tonkworks.makertablet.R;

public class ArduinoCommunicatorActivity extends Activity {

    private WebView mWebView;
    private WebSerialInterface webSerialInterface;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        webSerialInterface = new WebSerialInterface();

        mWebView = new WebView(this);        
        //mWebView.setSystemUiVisibility(View.SYSTEM_UI_FLAG_FULLSCREEN);
        mWebView.setSystemUiVisibility(8);
        mWebView.setWebChromeClient(new WebChromeClient());
        mWebView.getSettings().setJavaScriptEnabled(true);
        //mWebView.getSettings().setMediaPlaybackRequiresUserGesture(false);
        //mWebView.getSettings().setMediaPlaybackRequiresUserGesture(false); //Android < 4.2.2
        //mWebView.loadUrl("http://www.tonkworks.com/labs/kiosk");
        
        mWebView.addJavascriptInterface(new WebSerialInterface(), "serialusb");
   
        mWebView.loadUrl("file:///android_asset/www/Ackbar-motor.htm");

        

        
        //mWebView.loadUrl("javascript:alert(serialusb.databuffer())");
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.help:
            ...
            intent.putExtra(ArduinoCommunicatorService.DATA_EXTRA, buffer);
            sendBroadcast(intent);
            return true;
        case R.id.about:
        	String as = "13off";
            Intent aintent = new Intent(ArduinoCommunicatorService.SEND_DATA_INTENT);
            byte[] abuffer = as.getBytes();
            aintent.putExtra(ArduinoCommunicatorService.DATA_EXTRA, abuffer);
...
//            transferedData.add(newTransferedData);
            ...
            //mWebView.loadUrl("javascript:alert('" + transferedData + "'");
            mWebView.loadUrl("javascript:recievedData('" + new String(newTransferedData) + "')");
        }
    ...
    public class WebSerialInterface {
    	
        public String databuffer(){
			return "bbb";
        }
        @JavascriptInterface
        public String toString() { return "injectedObjectawdwadwadawd"; }
        @JavascriptInterface
        public void sendData(String s){
            Toast.makeText(getBaseContext(), "Sent " +s, Toast.LENGTH_SHORT).show();
